<nav class="navbar navbar-expand-lg navbar-light" style="min-width:350px; background-color: #D1B188;">
    <div class="container-fluid">
                ...
                <?php else:?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="index.php?pg=edit-admin&id=<?=Auth::get('id')?>">Profile-Settings</a></li>
        ...
        <div class="d-flex">
            ...
            <!-- Add any additional content you want to align to the right -->
        </div>
    </div>
</nav>
