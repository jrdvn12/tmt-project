...
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * FROM admin WHERE Position like 'Distributor Admin' OR 'Distributor Supervisor'OR 'Distributor Supervisor'";
  ...
  <?php include 'includes/user_distributor_modal.php'; ?>
</div>
