<?php require views_path('partials/header');?>
	...
	<div class="container-fluid border col-lg-4 col-md-5 mt-5 p-4 shadow-sm" >
		...
		<form method="post">
			...
			<div class="mb-3">
			  <input  value="<?=set_value('email')?>" autocomplete="off" name="email" type="text" class="form-control  <?=!empty($errors['email']) ? 'border-danger':''?>" id="exampleFormControlInput1" placeholder="Email" autofocus>
